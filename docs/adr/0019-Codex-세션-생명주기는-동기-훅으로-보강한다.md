...
Accepted — 부분 대체: [ADR 0020](0020-세션-시작-훅을-유휴-판정의-활동-바닥값으로-쓴다.md)이 `last_activity_at` 갱신 결정을 대체한다. [ADR 0022](0022-설정-제거는-마지막-적용-지문으로-판정한다.md)이 uninstall의 훅 제거에 마지막 적용 지문 비교를 추가한다. 명시적 재배선과 나머지 결정은 유효하다.
