...
export const PREFS: Pref[] = [
  ...
  },
  {
    ...
    icon: "▤",
    name: "로컬 데이터 보관 기간",
    desc: "기간이 지난 기록은 자동 정리됩니다",
    kind: "select",
    value: "30일",
    dbPath: "~/.pulsemetry/pulsemetry.db",
    dbSize: "18.4 MB",
  },
  {
    key: "notify",
...
export const COLLECTION: CollectionItem[] = [
  ...
  { icon: "⇢", label: "트레이스", key: "traces", sent: true },
  {
    icon: "✎",
    label: "사용자 프롬프트",
    key: "collect_user_prompts",
    sent: true,
  },
  {
    icon: "✳",
    label: "AI 응답",
    key: "collect_assistant_responses",
    sent: true,
  },
  {
    icon: "⚒",
    label: "도구 호출 정보",
    key: "collect_tool_details",
    sent: true,
  },
  {
    icon: "▤",
    label: "도구 입출력 내용",
    key: "collect_tool_content",
    sent: false,
  },
