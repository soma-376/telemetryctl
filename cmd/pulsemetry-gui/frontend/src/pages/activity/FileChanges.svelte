...
>
  ...
  {#each files as file (file.dir + file.name)}
    <div
      ...
      style="grid-template-columns:minmax(0,1fr) auto 34px;gap:9px;padding:6px 0"
    >
      <span
  ...
  <button
    ...
    style="font-size:12px;font-weight:500;padding:9px;border-radius:9px;margin-top:auto"
    >모든 파일 보기</button
  >
</div>
