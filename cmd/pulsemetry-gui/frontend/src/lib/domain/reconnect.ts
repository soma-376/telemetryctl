...
// period.ts 와 같은 모듈 단위 구독 상태를 쓴다.
...
const reconnectStore = createStore({
...
export const reconnect = reconnectStore.state;
export const useReconnect = reconnectStore.useStore;
